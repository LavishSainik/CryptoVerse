...
const stats = [
  ...
  return (
   <Col className='coin-detail-container'>
       ...
       <LineChart coinHistory={coinHistory} currentPrice={cryptoDetails.price} coinName = {cryptoDetails.name} change={cryptoDetails.change}/>
       ...
       <Col  className='stats-container'>
        ...
        <Col className="other-stats-info">
          <Col className="coin-value-statistics-heading">
            <Title level={3} className="coin-details-heading" style={{ color:'#1b1b1b !important' }}>
              Other Stats Info</Title>
